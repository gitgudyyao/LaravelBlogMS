...
@auth
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        <a class="btn btn-primary" href="{{ URL::to('/') }}"><i class="fa fa-arrow-right" aria-hidden="true" style="margin-right:10px;"></i> {{ __('Visit Main Page')}}
        </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>This action cannot be reversed, Are you sure you want to delete this?</strong>
                </div>
